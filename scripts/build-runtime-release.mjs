...
const REQUIRED_FILES = [
  ...
  'deploy/home-server/cloudflare-ingress-transaction.sh',
  'deploy/home-server/cloudflare-public-probe.sh',
  'deploy/home-server/verify-production-origin.sh',
  'deploy/home-server/verify-production-baseline.sh',
  'deploy/home-server/verify-release-manifest.sh',
  'deploy/home-server/production-runtime-identity.sh',
  'deploy/home-server/reconcile-production-baseline.sh',
