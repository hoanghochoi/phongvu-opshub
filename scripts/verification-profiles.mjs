...
export const PROFILES = Object.freeze([
  {
    ...
    pathPatterns: [
      ...
      /^scripts\/(?:agent-harness-block|archive-harness|build-harness|collect-harness|harness(?:-|$)|install-harness|materialize-core-state|promote-harness|review-harness-disposition|verify-(?:core|harness|materialized|revision)|validate-changeset-rebuild)/,
