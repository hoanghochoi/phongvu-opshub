...
export const PROFILES = Object.freeze([
  {
    ...
    pathPatterns: [
      ...
      /^scripts\/(?:agent-harness-block|archive-harness|build-harness|collect-(?:harness|artifact-inventory|ops72-shadow-metrics)|harness(?:-|$)|install-harness|materialize-core-state|promote-harness|review-harness-disposition|task-lifecycle|test-task-lifecycle|verify-(?:artifact-inventory|core|harness|materialized|migration-eol|ops72-live-shadow-evidence|ops72-shadow|plan-disposition|revision|task-shadow)|validate-changeset-rebuild)/,
