...
export const PROFILES = Object.freeze([
  {
    ...
    pathPatterns: [
      ...
      /^scripts\/(?:agent-harness-block|archive-harness|build-harness|collect-(?:harness|artifact-inventory)|harness(?:-|$)|install-harness|materialize-core-state|promote-harness|review-harness-disposition|verify-(?:artifact-inventory|core|harness|materialized|plan-disposition|revision)|validate-changeset-rebuild)/,
