...
| 34 | `/payment-monitor` | Transaction monitor / supported or unsupported screen | Payment Monitor feature; capability function currently returns supported | DATA + UNSUP; live/refresh/empty/error and explicit unsupported fallback | Shared responsive/state; Windows speaker capability remains separate | Operational |
