...
| VIETQR-001 | Manual VietQR transfer QR creation screen, API payload generation with optional amount/content, and admin MAP transaction search probe | yes | MAP live smoke partial | no | mobile smoke needed | changed | 2026-05-20: MAP UI search smoke succeeded; `npm run build`, `npm test -- --runInBand` |
