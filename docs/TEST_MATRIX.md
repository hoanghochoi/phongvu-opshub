...
| FIFO-001 | FIFO check, export/unexport, sort workflows against price_watchdog inventory, manual Excel inventory import, and admin history | partial | backend unit tests | no | mobile smoke needed | changed | 2026-05-24: added admin manual inventory Excel parser/import endpoint and UI entry; parser verified against sample file shape. 2026-05-23: added SR-scoped FIFO API and sort delegation, exported toggle contract, FIFO screen replacement for chat, and navigation cleanup; pending full live VPS smoke |
