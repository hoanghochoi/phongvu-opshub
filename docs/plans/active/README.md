...
- [`OPS-64-upstream-harness-repository-cleanup.md`](OPS-64-upstream-harness-repository-cleanup.md)
  remains the initiative master plan; OPS-185 is the current post-merge
  reconciliation after OPS-184/PR #309. Canonical `staging` and
  `origin/staging` are aligned at `c2d0af35`; the OPS-184 task worktree,
  ...
  deployment remain outstanding. OPS-184 is the preceding reconciliation
