...
- OPS-33, OPS-34, OPS-39 (hostname and H2H), OPS-40, OPS-42, OPS-43, OPS-45,
  OPS-52, OPS-60 and OPS-62 retain their own execution plans because testing,
  infrastructure, UAT or release gates remain open.
...
- [`OPS-64-upstream-harness-repository-cleanup.md`](OPS-64-upstream-harness-repository-cleanup.md)
  remains the initiative master plan; OPS-71 is its current cleanup slice.
