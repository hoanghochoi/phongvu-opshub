...
- Branch: `codex/ops-53-fifo-result-layout-runtime-fix`
- Base: `5cd200b6b378dcac164a012e88741f5cf8e8bfa1` (exact `origin/staging`)
...
| Compact FIFO results | `2288:23647`, card `2288:23705` | compact serial body and SKU item cards | Card anatomy: accent 7; pill visual 30; metadata tracks/wrap use 40px interaction rows; SKU repeats the same anatomy per item. |
