...
- Tab `Vận hành` hiển thị trực tiếp ô `Báo cáo bán hàng` dẫn tới
  ...
  và Lý do không mua. Bảng đơn chưa báo cáo gồm Mã showroom, Tên SA, Mã đơn hàng,
  Giá trị đơn và Thời gian bán; giá trị lấy từ `HomeSummaryOrderFact.grandTotal`.
