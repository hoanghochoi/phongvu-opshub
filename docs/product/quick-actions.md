...
Thứ tự cố định: Kiểm tra FIFO, VietQR, Báo cáo bán hàng, Tải app, Check-in,
Zalo OA và GG Map. Card `Công cụ nhanh` cũ trên Home không còn hiển thị.

## Quyền

- `QUICK_ACTIONS` là quyền gốc; từng action có một child feature riêng.
- FIFO, VietQR và Báo cáo bán hàng chỉ hiện khi cả child shortcut và feature
