...
> **Scope update (2026-08-21):** The MSIX build flow is retired and is no
> longer part of this story. The supported Windows release path is the signed
> EXE/ZIP workflow; the historical MSIX references below are retained only as
> migration evidence and must not be dispatched.
