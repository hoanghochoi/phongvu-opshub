...
import type { SalesProgressResponse } from './home-summary-sales-progress.runtime';
...
export class HomeSummaryService {
  ...
  constructor(
    ...
    this.salesProgressRuntime = new HomeSummarySalesProgressRuntime(
      this.prisma,
      {
        normalizeEmail: (value) => this.normalizeEmail(value),
        personalStoreGuard: (scope) => this.personalStoreGuard(scope),
        dateRangeFor: (summaryDate) => this.dateRangeFor(summaryDate),
  ...
  private async buildSalesProgress(
    ...
    return this.salesProgressRuntime.build(
      user,
      scope,
      summaryDate,
      selectedRange,
  ...
  private salesProgressReportWhere(
    ...
    return this.salesProgressRuntime.salesProgressReportWhere(scope, range);
  }
  ...
  private salesProgressRanges(summaryDate: Date) {
    return this.salesProgressRuntime.salesProgressRanges(summaryDate);
  }

  private async activeSaCountByStore(storeCodes: string[]) {
    return this.salesProgressRuntime.activeSaCountByStore(storeCodes);
  }
  ...
  private salesProgressWithActuals(
    ...
    return this.salesProgressRuntime.withActuals(
      status,
      scope,
      missingStoreCodes,
      actuals,
  ...
  private emptySalesProgress(): SalesProgressResponse {
    return this.salesProgressRuntime.empty();
  }
