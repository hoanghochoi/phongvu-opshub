...
class _MessageInputState extends State<MessageInput> {
  ...
  Future<void> _sendMessage() async {
    ...
    if (!Validators.isValidMessage(message)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Format không đúng. Nhập: SKU hoặc SKU SỐ_LƯỢNG\nVí dụ: ABC123 hoặc ABC123 10'),
              ...
              children: [
                ...
                IconButton(
                  ...
                  style: IconButton.styleFrom(
                    backgroundColor: isLoading ? Colors.grey[200] : Theme.of(context).colorScheme.primaryContainer,
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'Nhập SKU (VD: ABC123 hoặc ABC123 10)',
